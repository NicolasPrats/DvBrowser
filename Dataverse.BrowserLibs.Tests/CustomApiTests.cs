    ...
    public class CustomApiTests
    {
        ...
        public void Unbound()
        {
            ...
            WebApiRequest webApiRequest = WebApiRequest.CreateFromLocalPathWithQuery(
                "POST",
                $"/api/data/v9.2/dvb_test",
                new System.Collections.Specialized.NameValueCollection()
                {
                    {"Content-Type", "application/json" }
                },
                //TODO add entity + entityref
                ...
                //"{\"new_testbool\":true,\"new_testEntitycoll\":[],\"new_testdatetime\":\"2023-05-26T18:21:00.000Z\",\"new_testdecimal\":123.45,\"new_testEntityref\":{\"@odata.type\":\"Microsoft.Dynamics.CRM.contact\",\"contactid\":\"" + contactId + "\"},\"new_testfloat\":123.45,\"new_testint\":123,\"new_testmoney\":123,\"new_testpicklist\":123,\"new_teststring\":\"ABC\",\"new_teststringarray\":[\"abc\",\"def\"],\"new_testguid\":\"25a17064-1ae7-e611-80f4-e0071b661f01\"}"
                "{}"
                );
